...
const COUPLE_PHOTO =
  "https://cdn.poehali.dev/projects/95e3bf13-1d28-42e5-ba8a-ec6819a4f411/bucket/5a3980ed-375a-4c43-aaca-46595d1df269.jpg";
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-[#fdf8f4]">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-2xl mx-auto">
        <div
          className="animate-fade-in w-72 h-72 md:w-96 md:h-96 rounded-full overflow-hidden border-4 border-white shadow-2xl mb-10"
